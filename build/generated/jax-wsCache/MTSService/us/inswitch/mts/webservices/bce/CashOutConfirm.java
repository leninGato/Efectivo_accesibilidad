...
@XmlRootElement(name = "cashOutConfirm")
public class CashOutConfirm {

    @XmlElementRef(name = "dtoRequestCashOutConfirm", namespace = "http://bce.webservices.mts.inswitch.us", type = JAXBElement.class, required = false)
