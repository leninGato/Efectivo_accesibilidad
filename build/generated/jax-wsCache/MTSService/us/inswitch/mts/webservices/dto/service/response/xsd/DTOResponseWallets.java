...
/**
 * <p>Clase Java para DTOResponseWallets complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="DTOResponseWallets">
 *   &lt;complexContent>
 ...
 *         &lt;element name="walletList" type="{http://response.service.dto.webservices.mts.inswitch.us/xsd}DTOResponseWallet" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "DTOResponseWallets", propOrder = {
    "codeErrorId",
    "resultCode",
    "resultText",
    "utfi",
...
public class DTOResponseWallets {
    ...
    protected List<DTOResponseWallet> walletList;
    ...
    /**
     * Gets the value of the walletList property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the walletList property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getWalletList().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link DTOResponseWallet }
     * 
     * 
     */
    public List<DTOResponseWallet> getWalletList() {
        if (walletList == null) {
            walletList = new ArrayList<DTOResponseWallet>();
        }
