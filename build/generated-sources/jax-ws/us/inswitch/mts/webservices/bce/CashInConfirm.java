...
@XmlRootElement(name = "cashInConfirm")
public class CashInConfirm {

    @XmlElementRef(name = "dtoRequestCashInConfirm", namespace = "http://bce.webservices.mts.inswitch.us", type = JAXBElement.class, required = false)
