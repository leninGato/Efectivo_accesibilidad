...
/**
 * <p>Clase Java para DTOResponseRetrieveBatchLines complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="DTOResponseRetrieveBatchLines">
 *   &lt;complexContent>
 ...
 *         &lt;element name="retrieveBatchLineList" type="{http://response.web.dto.webservices.mts.inswitch.us/xsd}DTOResponseRetrieveBatchLine" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "DTOResponseRetrieveBatchLines", propOrder = {
    "codeErrorId",
    "resultCode",
    "resultText",
    "retrieveBatchLineList",
    "utfi"
})
public class DTOResponseRetrieveBatchLines {
    ...
    protected List<DTOResponseRetrieveBatchLine> retrieveBatchLineList;
    ...
    /**
     * Gets the value of the retrieveBatchLineList property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the retrieveBatchLineList property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRetrieveBatchLineList().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link DTOResponseRetrieveBatchLine }
     * 
     * 
     */
    public List<DTOResponseRetrieveBatchLine> getRetrieveBatchLineList() {
        if (retrieveBatchLineList == null) {
            retrieveBatchLineList = new ArrayList<DTOResponseRetrieveBatchLine>();
        }
        return this.retrieveBatchLineList;
    }
