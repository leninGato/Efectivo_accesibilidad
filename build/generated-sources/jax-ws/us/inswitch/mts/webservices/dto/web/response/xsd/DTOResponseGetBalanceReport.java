...
/**
 * <p>Clase Java para DTOResponseGetBalanceReport complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="DTOResponseGetBalanceReport">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="balanceReportList" type="{http://response.web.dto.webservices.mts.inswitch.us/xsd}DTOResponseBalanceReport" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "DTOResponseGetBalanceReport", propOrder = {
    "balanceReportList",
    "codeErrorId",
    "resultCode",
    "resultText",
...
public class DTOResponseGetBalanceReport {

    @XmlElement(nillable = true)
    protected List<DTOResponseBalanceReport> balanceReportList;
    ...
    /**
     * Gets the value of the balanceReportList property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the balanceReportList property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getBalanceReportList().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link DTOResponseBalanceReport }
     * 
     * 
     */
    public List<DTOResponseBalanceReport> getBalanceReportList() {
        if (balanceReportList == null) {
            balanceReportList = new ArrayList<DTOResponseBalanceReport>();
        }
        return this.balanceReportList;
    }
